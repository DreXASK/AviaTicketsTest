...
abstract class PositionViewBindingDelegateAdapter<T : Any, V : ViewBinding>(
    ...
    final override fun onBindViewHolder(holder: RecyclerView.ViewHolder, items: List<Any>, position: Int) {
        ...
        holder.viewBinding.onBind(items[position] as T, position)
    }

    abstract fun V.onBind(item: T, position: Int)
